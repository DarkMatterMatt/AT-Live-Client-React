...
function getIcon({ color, direction, opacity }: getIconProps): ImageURISource {
    ...
    return {
        uri: `data:image/svg+xml;base64,${encode(svg)}`,
        scale: 43/90
    };
}
